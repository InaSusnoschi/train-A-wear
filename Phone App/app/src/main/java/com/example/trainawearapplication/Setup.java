        ...
        public void onTextChanged(CharSequence s, int start, int before, int count) {
            if (height.getText().length() > 2) {
                ...
                if (num >= 130 && num <= 220) {
                    ...
                    Toast.makeText(Setup.this, "Please enter height in the range of 140-220cm", Toast.LENGTH_SHORT).show();
                    height.setText("");
                    num1 = -1;
                }
            }
...
//            }
            if (num1==-1)
            {
                Toast.makeText(Setup.this,"Please fill all the fields",Toast.LENGTH_SHORT).show();
            }
        }
    };
    ...
    TextWatcher textWeightWatcher =new TextWatcher() {
        ...
        public void onTextChanged(CharSequence s2, int start2, int before2, int count2) {
            if (weight.getText().length() > 1) {
                ...
                if (num_w >= 40 && num_w <= 120) {
                    ...
                    Toast.makeText(Setup.this, "Please enter weight in the range 40-120kg", Toast.LENGTH_SHORT).show();
                    weight.setText("");
                    num2 = -1;
                }
            }
        ...
        public void afterTextChanged(Editable s2) {
            ...
            if (num3==-1)
            {
                Toast.makeText(Setup.this,"Please fill the field",Toast.LENGTH_SHORT).show();
            }
        }
    };
        ...
        textAgeWatcher = new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s3, int start3, int before3, int count3) {
                ...
                if (num_a >= 16 && num_a <= 90) {
                    ...
                    if(num_a != 0){
                        Toast.makeText(Setup.this, "Please enter age in the range 16-90 y.o.", Toast.LENGTH_SHORT).show();
                        num3 = -1;}
