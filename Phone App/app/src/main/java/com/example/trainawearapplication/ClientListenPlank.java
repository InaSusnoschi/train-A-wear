...
public class ClientListenPlank implements Runnable {
    /**
     *
     ...
     *
     */
    final String TAG = "ClLstPlank";

    private int port;
    private DatagramSocket udpSocket;
    private TextView displayField;

    UdpClientHandlerPlank handler;
//    UdpClientHandlerPlank handlerPlank;
    ...
    public ClientListenPlank (int portNumber, TextView field, UdpClientHandlerPlank handler){
        port = portNumber;
        displayField = field;
    ...
    private void sendState(String state){
        handler.sendMessage(
                Message.obtain(handler,
                        UdpClientHandlerPlank.UPDATE_STATE, state));
    }
